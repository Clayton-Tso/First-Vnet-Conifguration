...
|ssh azadmin@Web-1 IP address                                                             	|to log into the Web-1 VM                           |
...
|sudo docker container start nervous_neumann && sudo docker container attach nervous_neumann|start and attach to the docker                     |
...
|http://20.51.104.15:5601/app/kibana#                                                       |Open web browser and navigate to Kibana Logs       |
